...
pub(super) fn read_autoincrement_seq(pager: &mut Pager, catalog: &Catalog, table_name: &str) -> Result<i64> {
...
pub(super) fn compute_autoincrement_rowid(pager: &mut Pager, catalog: &Catalog, table_name: &str, current_root: u32) -> Result<i64> {
